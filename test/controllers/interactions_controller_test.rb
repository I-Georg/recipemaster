...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post interactions_url, params: { interaction: { date: @interaction.date, rating: @interaction.rating, rec: @interaction.rec, recipe_id: @interaction.recipe_id, review: @interaction.review, user_id: @interaction.user_id } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { date: @interaction.date, rating: @interaction.rating, rec: @interaction.rec, recipe_id: @interaction.recipe_id, review: @interaction.review, user_id: @interaction.user_id } }
